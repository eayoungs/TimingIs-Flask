...
invoiceItemsDct = {'Project1': {0: {'duration': 2, 'description': 'Work'},
                                1: {'duration': 1.5, 'description':
                                    'Some otherwork'}
                                },
                   'Project2': {2: {'duration': 2, 'description': 'Work'},
                                3: {'duration': 1.5, 'description':
                                    'Some other work'}
                                }
                   }
...
def main(invoiceItemsDct=invoiceItemsDct, calendar=calendar,
         eventType=eventType,
         project=project,
    ...
    for key1, value1 in invoiceItemsDct.items():
        for key2, value2 in value1.items():
            doc.add_item(Item(key1, value2['description'], value2['duration'],
                              billing_rate))
